...
public class TheaterVO {
	...
	public TheaterVO(String thr_name, String thr_loc, String thr_addr, String thr_addr_detail, String thr_info,
			String admin_id, String admin_pwd, String thr_tel, Date regdate) {
		super();
