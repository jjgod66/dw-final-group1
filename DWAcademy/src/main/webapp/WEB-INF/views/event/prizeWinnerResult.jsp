	...
	<div class="inner-wrap">
		...
		<div class="table-wrap">
			<div class="board-view">
				<div class="tit-area">
					<p class="tit">&lt;극장판 피노키오 위대한 모험&gt; 메가박스 회원 시사회</p>
				</div>

				<div class="info">
					<p>
						<span class="txt">2023.06.20 ~ 2023.07.05</span>
					</p>
				</div>
		...
		<div class="btn-group  pt40">
			<a href="<%=request.getContextPath() %>/event/prizeWinner.do" onclick="hisBack()" class="button large winnerlist"
