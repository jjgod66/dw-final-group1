...
<link rel="stylesheet" href="/css/dwcinema.css">
...
<header class="header">
    <nav class="gnb">
        <div class="container d-flex flex-wrap">
            ...
            <ul class="nav">
                <li class="nav-item"><a href="login.jsp" class="nav-link link-dark px-2">로그인</a></li>
    ...
    <div class="container" stlyle="overflow: hidden;">
        <ul class="navbar" role="menubar" id="dwcinema_gnb">
            ...
            <li role="menuitem">
                <strong>예매하기</strong>
                <ul style="opacity: 0; height: 0px;">
                    <li><a href="movie-reservation.jsp">상영시간표</a></li>
                    <li><a href="#">할인안내</a></li>
                </ul>
            </li>
            <li role="menuitem">
                <strong>스토어</strong>
                <ul style="opacity: 0; height: 0px;">
                    <li><a href="store.jsp?CategoryIdx=2">영화관람권</a></li>
                    <li><a href="store.jsp?CategoryIdx=3">기프트카드</a></li>
                    <li><a href="store.jsp?CategoryIdx=4">팝콘/스낵/음료</a></li>
                </ul>
            </li>
            <li role="menuitem">
                <strong>이벤트</strong>
