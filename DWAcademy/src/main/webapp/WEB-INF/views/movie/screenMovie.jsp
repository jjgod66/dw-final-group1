		...
		<c:if test="${mem_cd eq '' }">
			<div class="tab-list fixed noneMem">
				<ul class="nav nav-tabs" role="tablist">
					...
					<li class="nav-item active"><a href="<%=request.getContextPath()%>/movie/screenMovie.do">현재상영</a></li>
		...
		<c:if test="${mem_cd ne '' }">
			<div class="tab-list fixed likeGenre">
				<ul class="nav nav-tabs" role="tablist">
					...
					<li class="nav-item active" style="width: 25%;"><a href="<%=request.getContextPath()%>/movie/screenMovie.do">현재상영</a></li>
