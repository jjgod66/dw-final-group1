	...
	<div style="width: 1300px; margin: 0 auto;">
		...
		<c:if test="${mem_cd eq '' }">
			<div class="tab-list fixed noneMem">
				<ul class="nav nav-tabs" role="tablist">
					<li class="nav-item active"><a href="<%=request.getContextPath()%>/movie/allMovie.do">전체</a></li>
		...
		<c:if test="${mem_cd ne '' }">
			<div class="tab-list fixed likeGenre">
				<ul class="nav nav-tabs" role="tablist">
					<li class="nav-item active" style="width: 25%;"><a href="<%=request.getContextPath()%>/movie/allMovie.do">전체</a></li>
					...
					<li class="nav-item" id="like" style="width: 25%;"><a href="<%=request.getContextPath()%>/movie/likeGenreMovie.do">선호장르</a></li>
				</ul>
			</div>
		</c:if>
...
// 		$('.noneMem').css('display', 'none');
// 		$('.likeGenre').css('display', '');
