            ...
            <div class="card__header">
              <div class="header-in-card">
                <div class="header-in-card__menu">
                  <div class="menu">
                    <div class="menu__icon"><span></span><span></span><span></span></div>
	                    <a href="http://" target="_blank" class="menu__item">상세보기</a>
	                    <a href="http://" target="_blank" class="menu__item">예매하기</a>
                  </div>
                </div>
