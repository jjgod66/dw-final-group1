		...
		<div class="ms-3 me-3">
			<div>
				<div class="mt-3 mb-3" style="display: flex; justify-content: space-between;">
					...
					<span class="ms-3 me-3"><input type="text" style="height:1.5rem;" name="keyword"> <button class="bc_dw_black ms-2 " onclick="javascript:searchList_go(1);">검색</button>  <button class="bc_dw_blue ms-2 " id="registBtn">이벤트 등록</button></span>
