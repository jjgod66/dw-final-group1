						...
						<div class="movie-infomation-area">
							...
							<div class="movie-info-middle">
								<ul class="dot-list gray">
									<li><span>예매영화 <!-- 예매영화 --></span> 미션 임파서블: 데드 레코닝 PART ONE / 2D(자막)</li>
									<li><span>관람극장/상영관 <!-- 관람극장/상영관 --></span> 대전현대아울렛 / 2관</li>
									<li><span>관람일시 <!-- 관람일시 --></span> &nbsp;2023.07.13 (목) 14:35</li>
									<li><span>관람인원 <!-- 관람인원 --></span> &nbsp;성인 1명</li>
									<li><span>좌석번호 <!-- 좌석번호 --></span> &nbsp;F열 8</li>
									<li><span>전화번호 <!-- 전화번호 --></span> &nbsp;010-8771-4407</li>
									<li>
										<span>결제정보 <!-- 결제정보 --></span>
										<strong class="roboto">13,000</strong> 원 <!-- 원 --><br>
										<em></em>
									</li>
								</ul>
				...
				<div class="popup-gray mid-info-box mb10">
					<div class="pop-search-area line-wid">
						<div class="pop-search-area-line">
							...
							<input type="hidden" id="trans_no" title="거래번호 입력" class="input-text w250px x-small" value="00172307130094204567" maxlength="20">
						...
						<ul class="dot-list gray">
								...
								<li class="mt20">
									...
									<ul class="dash-list">
											...
											<li>3층 매표소(매점)에서 차량번호 인증 후 3시간 무료주차 등록(당일 영화티켓 지참)</li>
										
											<li>현재 주차공간이 매우 협소하므로 충분한 시간적 여유를 가지고 방문바라며 가급적 대중교통 이용을 부탁드립니다. (주차 지연으로 인한 티켓 환불 불가)</li>
