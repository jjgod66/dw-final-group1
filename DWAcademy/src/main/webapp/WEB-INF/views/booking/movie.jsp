...
<div class="container">
    <div class="schedule-tab">
        <ul>
            <li class="btn-schedule"><button type="button" class="tab_tit" style="width: 50%; left: 0%;" data-tablist="cinema"><span>영화관별 상영시간표</span></button></li>
            <li class="btn-schedule active"><button type="button" class="tab_tit" style="width: 50%; left: 50%;" data-tablist="movie"><span>영화별 상영시간표</span></button></li>
        </ul>
    </div>
</div>
        ...
        <div class="movie-select">
            <div class="group_top"><h4 class="tit">영화 선택</h4></div>
                <div class="mvList">
                    <ul>
                        <li class="btnMovie">
                            <a href="#none" data-moviecd="20228930">
...
var movieTimes = [
  ...
  { time: "10:00", duration: "1시간 40분", totalSeats: 112, remainingSeats: 112, date: "2023-07-12" },
  { time: "13:30", duration: "2시간 10분", totalSeats: 112, remainingSeats: 112, date: "2023-07-12" },
  { time: "16:20", duration: "1시간 50분", totalSeats: 112, remainingSeats: 112, date: "2023-07-12" },
  { time: "19:00", duration: "2시간 30분", totalSeats: 112, remainingSeats: 112, date: "2023-07-12" },
  { time: "10:00", duration: "1시간 40분", totalSeats: 112, remainingSeats: 112, date: "2023-07-13" },
  { time: "13:30", duration: "2시간 10분", totalSeats: 112, remainingSeats: 112, date: "2023-07-13" },
  { time: "16:20", duration: "1시간 50분", totalSeats: 112, remainingSeats: 112, date: "2023-07-13" },
  { time: "19:00", duration: "2시간 30분", totalSeats: 112, remainingSeats: 112, date: "2023-07-13" }
];
