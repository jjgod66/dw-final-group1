...
#reviewUpdate-modal .modal-content{
    border-radius: 0.7rem;
}
#reviewUpdate-modal .modal-header img{
    width: 100px;
}
#reviewUpdate-modal .modal-title{
    margin-left:auto;
    margin-right: auto;
}
#reviewUpdate-modal .modal-header{
    border-bottom: none;
    padding-bottom: 0;
    padding-top: 4vh;
}
#reviewUpdate-modal .modal-footer{
    border-top: none;
}
#reviewUpdate-modal button:active{
    outline: none;
}
#reviewUpdate-modal button:focus{
   outline: none;
}
#reviewUpdate-modal .modal-body{
    text-align: center;
}
#reviewUpdate-modal form{
    padding: 3vh;
}
#reviewUpdate-modal input {
    outline: none;
    margin: 0;
    border: none;
...
#reviewUpdate-modal .input-group {
    margin-bottom: 1rem;
}
#reviewUpdate-modal .input--style-3 {
...
#reviewUpdate-modal .extra{
      padding-bottom: 4vh;
      color: rgb(143, 141, 141);
     font-size:13px;
}
#reviewUpdate-modal .extra a{
    color: rgb(143, 141, 141);
    font-size:13px;
}
#reviewUpdate-modal .col{
      padding: 2vh 10px 4vh;
}
#reviewUpdate-modal .new{
      padding-bottom: 0;
}
#reviewUpdate-modal .btn-primary{
      width:40%;
      margin:30%
}
#reviewUpdate-modal .btn:focus{
    box-shadow: none;
    outline: none;
}
</style>
<div class="modal fade" id="reviewUpdate_modal">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <!-- Modal body -->
            <div class="modal-body">
            	<h3 class="fs-3 text-center my-2"></h3>
            	<h5 id="reviewMovieName">영화 "${myReivewList}"</h5><h5>어떠셨나요?</h5>
