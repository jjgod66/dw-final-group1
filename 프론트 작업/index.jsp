...
<%@include file="common/boxoffice.jsp" %>
<div class="boxoffice">
    <div class="container">
...
%>
<%@include file="common/boxoffice_list.jsp" %>
                                ...
                                <div class="thumb_item">
                                    <div class="poster_movie" style="<%=posterImage%>">
                                        ...
                                        <div class="movieChart_btn_wrap">
                                            <a href="movie-viewer.jsp?movieCd=<%=movieCd%>" class="btn_movieChart_detail">상세보기</a>
                                            <a href="movie-reservation.jsp?movieCd=<%=movieCd%>" class="btn_movieChart_ticketing">예매하기</a>
                                        </div>
                                    </div>
                                </div>
