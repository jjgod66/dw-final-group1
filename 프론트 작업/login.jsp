...
<%@include file="common/member_header.jsp" %>
        ...
        <div class="login">
            ...
            <div class="login__account">
                <div class="login__id-pw">
                    <a href="https://account.pmang.com/Find/findid?path=LOGINFORMN" class="login__find-id">아이디</a>
                    또는
                    <a href="https://account.pmang.com/Find/findpwd?path=LOGINFORMN" class="login__find-pw">비밀번호</a>를 잊으셨나요?
                </div>
                <a href="https://account.pmang.com/SignUp_account?client_id=PMANG&amp;path=LOGINFORMN&amp;redirect_uri=https%3A%2F%2Fwww.pmang.com" class="login__sign-up">회원가입</a>
            </div>
            ...
            <div class="login__auth-by">
                <a href="javascript:sns('nopenid', 'LOGINFORM');" class="login__auth"><i class="login__icon-naver"></i>Naver 계정으로 로그인</a>
                <a href="javascript:sns('facebook', 'LOGINFORM');" class="login__auth"><i class="login__icon-facebook"></i>Facebook 계정으로 로그인</a>
                <a href="javascript:sns('google', 'LOGINFORM');" class="login__auth"><i class="login__icon-google"></i>Google 계정으로 로그인</a>
            </div>
        </div>
    </div>
    ...
    <script type="text/javascript">
        ...
        function signInSubmit() {
            ...
            var strAction = "/signInNw";
    
            // if(location.protocol != "https:" && location.hostname != "localhost") {
            //     location.href = "https://www.pmang.com/login";
            //     return;
            //     // strAction = "https://" + location.hostname + strAction;
            // }
...
<%@include file="common/member_footer.jsp" %>