        ...
        <div class="content_wrap">
            <div class="row">
                <div class="col-12 col-lg-3">
                    <a href="store-detail.jsp" class="btn_category_product">
                        <span class="com_list_img_wrap"><img src="img/store/ERDC5wGVMC0YZPIRUsuuaJuAGRyqeDjC_280.png"></span>
                ...
                <div class="col-12 col-lg-3">
                    <a href="store-detail.jsp" class="btn_category_product">
                        <span class="com_list_img_wrap"><img src="img/store/qB1IVqlOLCV7hOOEAJp4J9iG3J5oVWjv_280.png"></span>
                        <span class="com_list_text_wrap">
                ...
                <div class="col-12 col-lg-3">
                    <a href="store-detail.jsp" class="btn_category_product">
                        <span class="com_list_img_wrap"><img src="img/store/15464115505070.jpg"></span>
                        <span class="com_list_text_wrap">
                ...
                <div class="col-12 col-lg-3">
                    <a href="store-detail.jsp" class="btn_category_product">
                        <span class="com_list_img_wrap"><img src="img/store/15464120861130.jpg"></span>
                        <span class="com_list_text_wrap">
                ...
                <div class="col-12 col-lg-3">
                    <a href="store-detail.jsp" class="btn_category_product">
                        <span class="com_list_img_wrap"><img src="img/store/16751302793100.jpg"></span>
                        <span class="com_list_text_wrap">
