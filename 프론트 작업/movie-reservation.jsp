...
<div class="main-schedule">
    <div class="container">
      ...
      <h3 class="h3-sc">영화 선택</h3>
      <div class="mvList">
          <div class="row">
              <div class="col-12 col-lg-3">
                  <button type="button" class="btnMovie" data-moviecd="20228930">
                      <span>엘리멘탈</span>
                  </button>
              </div>
              <div class="col-12 col-lg-3">
                  <button type="button" class="btnMovie" data-moviecd="20226411">
                      <span>범죄도시 3</span>
                  </button>
              </div>
          </div>
...
btnMovies.forEach(function(btnMovie) {
  btnMovie.addEventListener('click', function() {
    ...
    btnMovies[0].classList.remove('active');
